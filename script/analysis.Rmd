...
sink("output/tables/table09.txt")
...
sink("output/tables/table19.txt")
stargazer(list(r19a,r19b,r19c), type= "html")
sink()

stargazer(list(r19a,r19b,r19c), type= "text")
```
...
sink("output/tables/table_redis.txt")
stargazer(list(reg1a,reg3a,reg4a,reg1b,reg3b,reg4b,reg1c,reg3c,reg4c), type="text")
sink()
