...
La base ISSP 2019 aun no se encuentra disponible como tal, ya que toma un par de años recopilar la información de todos los países y ajustarla para su distribución. Sin embargo, la institución contraparte de ISSP en Chile (CEP - Centro de Estudios Públicos) ya liberó los datos de su encuesta 2019 donde se encuentra ISSP, desde donde los pudimos extraer y fusionar con las bases de datos anteriores de 1999 y 2009.
